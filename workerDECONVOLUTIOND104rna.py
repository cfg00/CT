...
#r'\\merfish8\merfish8v2\20230801D104Myh67d80\DNA_singleCy5\AnalysisDeconvolveCG'
...
def main_f(set_ifov,try_mode=True):
    ...
    #merfish8v1 (H8):  \\merfish8\merfish8v1\20230801D104Myh67d80\RNA and merfish8v2 (H1-H7, H9-H33):
    #\\merfish8\merfish8v2\20230801D104Myh67d80\RNA
    
    all_flds_ = glob.glob(r'\\merfish8\merfish8v1\20230801D104Myh67d80\RNA\H*Q*'+set__) #####modify for 3-col small tad 
    redefine_color += [[0,1,2,3]]*len(all_flds_) #### three signal color
    all_flds+=all_flds_

    all_flds_ = glob.glob(r'\\merfish8\merfish8v2\20230801D104Myh67d80\RNA\H*Q*'+set__) #####modify for 3-col small tad 
    redefine_color += [[0,1,2,3]]*len(all_flds_) #### three signal color
    all_flds+=all_flds_
    '''
    idea, have a for loop that does this, and have it be something like:
    [s for in all_flds if H(i) in s]

    this should avoid using any hybs that are still in progress, and doesn't mess w dapi feature finding.
    '''
